...
const batchRecord = (model) => {
    ...
    _.set(result, 'operationNo', _.get(model, 'nro_ordem_credito', ''));
    _.set(result, 'refDate', _.get(model, 'data_rv', ''));
    _.set(result, 'taxDate', _.get(model, 'data_rv', ''));
    _.set(result, 'dueDate', _.get(model, 'dt_vencimento', ''));
    ...
    _.set(result, 'rate', _.get(model, 'taxa_administracao', 0));
    ...
    _.set(result, 'sourceDb', 'cldr_rede_saldos');
