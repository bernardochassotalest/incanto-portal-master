...
class AcquirerRejections extends Model {
  static init(sequelize) {
    super.init({
      ...
      rejectionCode: DataTypes.STRING,
      rejectionName: DataTypes.STRING,
    ...
    {
      sequelize, modelName: 'acquirerRejections'
    });
  }
}
export default AcquirerRejections;
