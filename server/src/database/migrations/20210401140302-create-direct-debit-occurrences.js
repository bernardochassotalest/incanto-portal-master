...
const tableName = 'directDebitOccurrences'

const structure = (Sequelize) => {
  return {
    id: { type: Sequelize.STRING(50), primaryKey: true, allowNull: false },
    transactionId: { type: Sequelize.STRING(50), allowNull: false, references: { model: 'directDebitTransactions', key: 'id', onUpdate: 'CASCADE', onDelete: 'CASCADE' } },
